                            ...
                            <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                ...
                                <form onSubmit={handleSubmit} className="space-y-4">
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700">Current CTC (LPA) (Optional)</label>
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700">Expected (LPA) (Optional)</label>
