    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const dataArray = [
                ...
                "J-3", // step code for Induction Training
                timestamp,
                formData.status,
                "", // Column E placeholder (Attachment)
    ...
    return (
        <div className="space-y-6 page-content p-6">
            <div className="flex items-center justify-between">
                <h1 className="text-2xl font-bold text-gray-800 uppercase">Induction Training</h1>
            </div>
            {/* Search & Tabs */}
                                    ...
                                    filteredData.map((item, idx) => (
                                        <tr key={idx} className="hover:bg-gray-50">
                                            <td className="px-6 py-4 whitespace-nowrap text-sm">
                                                <button onClick={() => handleOpenModal(item)} className="bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 transition-colors">Update Status</button>
                                            </td>
